...
<body>
  ...
  <img class="wave" src="img/goals.svg">
                        ...
                        <form method="post" name = "reviewform" onsubmit="return validateform()" action="postReview.php" >
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="input_field">
                                            <input type="text" name="job_post" placeholder="Post" onkeypress="return isChar(event)">
                                    </div>
                                </div>
                                 <div class="col-md-2">
                                    <div class="input_field">
                                            <input type="text" name="salary" placeholder="Salary" onkeypress="return isNumber(event)">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input_field">
                                           <input type="text" name="job_duration" placeholder="Job duration" onkeypress="return isNumber(event)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-11">
                                <div class="input_field">
                                        <textarea name="experience" id="" cols="30" rows="10" placeholder="experience"></textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="submit_btn">
                                        <button id="spost"  class="btn btn-outline-success w-100" name = "submit" type="submit">Save Review</button>
