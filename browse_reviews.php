                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo  "<div class='links_locat d-flex align-items-center'>
                                        <div class='location'>
                                            <p> <i class='fa fa-map-marker'></i> {$cname}</p>
                                        </div>
                                        <div class='location'>
                                            <p> <i class='fa fa-clock-o'></i> {$type}</p>
                                        </div>
                                        <div class='location'>
                                            <p>posted by: {$postemail}</p>
                                        </div>
                                        ...
                                        <div class='location'>
                                         ...
                                         <div class='apply_now'>
                                         <a class='heart_mark' href='browse_reviews.php'> <i class='ti-heart'></i> </a>
