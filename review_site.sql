...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2020 at 11:15 PM
...
(6, 'MD. NOZIB UD DOWLA', '16-33040-3@student.aiub.edu', 'Ass$4569', '');
...
('16-33040-3@student.aiub.edu', 42, 'Developer', 'Raptas Software Inc', 'Full Stack Web Developer', 70000, '4', 'Full Time', 'House 47, RD 4 , Sector 3,', '4 to 5 year(s)', 10),
('16-33040-3@student.aiub.edu', 43, 'Developer', 'Shafi Consultancy Limited', 'Front-End Developer', 50000, '2', 'Part Time', '93, Kajolshah, Sylhet, Bangladesh', 'At least 2 year(s)\r\nThe applicants should have experience in the following area(s): UI Design, UX Design, Web Front End Development\r\nThe applicants should have experience in the following business area(s): Software Company, IT Enabled Service', 9);
